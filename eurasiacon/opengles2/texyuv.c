 ...
 * Created      : 22/02/11
 *
 * Copyright    : 2007-2011 by Imagination Technologies Limited.
 ...
 * Platform     : ANSI
 *
 * Description	: YUV texture support functions, based on texstream.c r1.32
 *
 * Modifications:-
 * $Log: texyuv.c $
 **************************************************************************/
...
IMG_INTERNAL IMG_VOID InitialiseYUVCoefficients(YUV_REGISTERS *psYUVRegisters, PVRSRV_PIXEL_FORMAT ePixelFormat, IMG_UINT32 ui32Flags)
{
	...
	*/
	...
	{
		GLES2MemCopy(&sTransferMatrix, &s709, sizeof(YUV_CSC_COEFF));
	}
	else
	{
		GLES2MemCopy(&sTransferMatrix, &s601, sizeof(YUV_CSC_COEFF));
	}
...
IMG_INTERNAL IMG_VOID CopyYUVRegisters(GLES2Context *gc, YUV_REGISTERS *psYUVRegisters)
{
	if(psYUVRegisters->bUseFIRH)
	{
...
/***********************************************************************************
 Function Name      : CreateExternalTextureState
 Inputs             :
 Outputs            :
 Returns            :
 Description        :
************************************************************************************/
IMG_INTERNAL PVRSRV_ERROR CreateExternalTextureState(GLES2ExternalTexState *psExtTexState,
													...
													IMG_UINT32 ui32Flags)
{
	...
	IMG_BOOL abUseStride[GLES2_MAX_TEX_PLANES] = {IMG_FALSE, IMG_FALSE, IMG_FALSE};
	...
	if(ui32WidthLog2 > GLES2_MAX_TEXTURE_MIPMAP_LEVELS)
	{
	...
	if(ui32HeightLog2 > GLES2_MAX_TEXTURE_MIPMAP_LEVELS)
	{
	...
	switch(ePixelFormat)
	{
		...
		case PVRSRV_PIXEL_FORMAT_FOURCC_ORG_VYUY:
		{
			...
			InitialiseYUVCoefficients(&(psExtTexState->sYUVRegisters), ePixelFormat, ui32Flags);
...
#endif /* GLES2_EXTENSION_TEXTURE_STREAM || GLES2_EXTENSION_EGL_IMAGTERNAL*/
