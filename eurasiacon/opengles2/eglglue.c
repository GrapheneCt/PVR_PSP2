...
static GetProcAddressReturnFunc GLES2GetProcAddress(const char *procname)
{
	...
	COMPARE_AND_RETURN(glAttachShader)
	COMPARE_AND_RETURN(glBindAttribLocation)
	COMPARE_AND_RETURN(glBindBuffer)
	COMPARE_AND_RETURN(glBindFramebuffer)
	COMPARE_AND_RETURN(glBindRenderbuffer)
	COMPARE_AND_RETURN(glBindTexture)
	COMPARE_AND_RETURN(glBlendColor)
	COMPARE_AND_RETURN(glBlendEquation)
	COMPARE_AND_RETURN(glBlendEquationSeparate)
	COMPARE_AND_RETURN(glBlendFunc)
	COMPARE_AND_RETURN(glBlendFuncSeparate)
	COMPARE_AND_RETURN(glBufferData)
	COMPARE_AND_RETURN(glBufferSubData)
	COMPARE_AND_RETURN(glCheckFramebufferStatus)
	...
	COMPARE_AND_RETURN(glCompileShader)
	...
	COMPARE_AND_RETURN(glCreateProgram)
	COMPARE_AND_RETURN(glCreateShader)
	COMPARE_AND_RETURN(glCullFace)
	COMPARE_AND_RETURN(glDeleteBuffers)
	COMPARE_AND_RETURN(glDeleteFramebuffers)
	COMPARE_AND_RETURN(glDeleteProgram)
	COMPARE_AND_RETURN(glDeleteRenderbuffers)
	COMPARE_AND_RETURN(glDeleteShader)
	...
	COMPARE_AND_RETURN(glDetachShader)
	COMPARE_AND_RETURN(glDisable)
	COMPARE_AND_RETURN(glDisableVertexAttribArray)
	COMPARE_AND_RETURN(glDrawArrays)
	COMPARE_AND_RETURN(glDrawElements)
	COMPARE_AND_RETURN(glEnable)
	COMPARE_AND_RETURN(glEnableVertexAttribArray)
	COMPARE_AND_RETURN(glFinish)
	COMPARE_AND_RETURN(glFlush)
	COMPARE_AND_RETURN(glFramebufferRenderbuffer)
	COMPARE_AND_RETURN(glFramebufferTexture2D)
	COMPARE_AND_RETURN(glFrontFace)
	COMPARE_AND_RETURN(glGenBuffers)
	COMPARE_AND_RETURN(glGenFramebuffers)
	COMPARE_AND_RETURN(glGenRenderbuffers)
	COMPARE_AND_RETURN(glGenTextures)
	COMPARE_AND_RETURN(glGenerateMipmap)
	COMPARE_AND_RETURN(glGetActiveAttrib)
	COMPARE_AND_RETURN(glGetActiveUniform)
	COMPARE_AND_RETURN(glGetAttachedShaders)
	COMPARE_AND_RETURN(glGetAttribLocation)
	...
	COMPARE_AND_RETURN(glGetFramebufferAttachmentParameteriv)
	COMPARE_AND_RETURN(glGetIntegerv)
	COMPARE_AND_RETURN(glGetProgramInfoLog)
	COMPARE_AND_RETURN(glGetProgramiv)
	COMPARE_AND_RETURN(glGetRenderbufferParameteriv)
	COMPARE_AND_RETURN(glGetShaderInfoLog)
	COMPARE_AND_RETURN(glGetShaderPrecisionFormat)
	COMPARE_AND_RETURN(glGetShaderSource)
	COMPARE_AND_RETURN(glGetShaderiv)
	COMPARE_AND_RETURN(glGetString)
	COMPARE_AND_RETURN(glGetTexParameterfv)
	COMPARE_AND_RETURN(glGetTexParameteriv)
	COMPARE_AND_RETURN(glGetUniformLocation)
	COMPARE_AND_RETURN(glGetUniformfv)
	COMPARE_AND_RETURN(glGetUniformiv)
	COMPARE_AND_RETURN(glGetVertexAttribPointerv)
	COMPARE_AND_RETURN(glGetVertexAttribfv)
	COMPARE_AND_RETURN(glGetVertexAttribiv)
	COMPARE_AND_RETURN(glHint)
	COMPARE_AND_RETURN(glIsBuffer)
	COMPARE_AND_RETURN(glIsEnabled)
	COMPARE_AND_RETURN(glIsFramebuffer)
	COMPARE_AND_RETURN(glIsProgram)
	COMPARE_AND_RETURN(glIsRenderbuffer)
	COMPARE_AND_RETURN(glIsShader)
	COMPARE_AND_RETURN(glIsTexture)
	COMPARE_AND_RETURN(glLineWidth)
	COMPARE_AND_RETURN(glLinkProgram)
	COMPARE_AND_RETURN(glPixelStorei)
	COMPARE_AND_RETURN(glPolygonOffset)
	COMPARE_AND_RETURN(glReadPixels)
	COMPARE_AND_RETURN(glReleaseShaderCompiler)
	COMPARE_AND_RETURN(glRenderbufferStorage)
	COMPARE_AND_RETURN(glSampleCoverage)
	COMPARE_AND_RETURN(glScissor)
	COMPARE_AND_RETURN(glShaderBinary)
	COMPARE_AND_RETURN(glShaderSource)
	COMPARE_AND_RETURN(glStencilFunc)
	COMPARE_AND_RETURN(glStencilFuncSeparate)
	COMPARE_AND_RETURN(glStencilMask)
	COMPARE_AND_RETURN(glStencilMaskSeparate)
	COMPARE_AND_RETURN(glStencilOp)
	COMPARE_AND_RETURN(glStencilOpSeparate)
	...
	COMPARE_AND_RETURN(glUniform1f)
	COMPARE_AND_RETURN(glUniform1fv)
	COMPARE_AND_RETURN(glUniform1i)
	COMPARE_AND_RETURN(glUniform1iv)
	COMPARE_AND_RETURN(glUniform2f)
	COMPARE_AND_RETURN(glUniform2fv)
	COMPARE_AND_RETURN(glUniform2i)
	COMPARE_AND_RETURN(glUniform2iv)
	COMPARE_AND_RETURN(glUniform3f)
	COMPARE_AND_RETURN(glUniform3fv)
	COMPARE_AND_RETURN(glUniform3i)
	COMPARE_AND_RETURN(glUniform3iv)
	COMPARE_AND_RETURN(glUniform4f)
	COMPARE_AND_RETURN(glUniform4fv)
	COMPARE_AND_RETURN(glUniform4i)
	COMPARE_AND_RETURN(glUniform4iv)
	COMPARE_AND_RETURN(glUniformMatrix2fv)
	COMPARE_AND_RETURN(glUniformMatrix3fv)
	COMPARE_AND_RETURN(glUniformMatrix4fv)
	COMPARE_AND_RETURN(glUseProgram)
	COMPARE_AND_RETURN(glValidateProgram)
	COMPARE_AND_RETURN(glVertexAttrib1f)
	COMPARE_AND_RETURN(glVertexAttrib1fv)
	COMPARE_AND_RETURN(glVertexAttrib2f)
	COMPARE_AND_RETURN(glVertexAttrib2fv)
	COMPARE_AND_RETURN(glVertexAttrib3f)
	COMPARE_AND_RETURN(glVertexAttrib3fv)
	COMPARE_AND_RETURN(glVertexAttrib4f)
	COMPARE_AND_RETURN(glVertexAttrib4fv)
	COMPARE_AND_RETURN(glVertexAttribPointer)
