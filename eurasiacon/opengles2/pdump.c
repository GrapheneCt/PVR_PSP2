 ...
 * Platform     : ANSI
 *
 * $Date: 2010/01/22 14:21:02 $ $Revision: 1.21 $
 * $Log: pdump.c $
 **************************************************************************/
...
IMG_INTERNAL IMG_BOOL PDumpString(GLES2Context *gc, IMG_CHAR *pszFormat, ...)
{
...
IMG_INTERNAL IMG_BOOL PDumpStringContinuous(GLES2Context *gc, IMG_CHAR *pszFormat, ...)
{
	IMG_CHAR szScript[256];
...
IMG_INTERNAL IMG_BOOL PDumpReg(GLES2Context *gc, IMG_UINT32 ui32Addr, IMG_UINT32 ui32Data)
{
...
************************************************************************************/
IMG_INTERNAL IMG_BOOL PDumpPoll(GLES2Context *gc, IMG_UINT32 ui32Addr, IMG_UINT32 ui32Data)
{
...
************************************************************************************/
IMG_INTERNAL IMG_BOOL PDumpSync(GLES2Context *gc, IMG_VOID *pvAltLinAddr, PVRSRV_CLIENT_SYNC_INFO *psSyncInfo, IMG_UINT32 ui32Offset, IMG_UINT32 ui32Bytes)
{
...
IMG_INTERNAL IMG_BOOL PDumpMem(GLES2Context *gc, PVRSRV_CLIENT_MEM_INFO *psMemInfo, 
...
IMG_INTERNAL IMG_VOID PDumpSetFrame(GLES2Context *gc)
{
	PVRSRVPDumpSetFrame(gc->ps3DDevData->psConnection, gc->ui32FrameNum);
}

IMG_INTERNAL IMG_BOOL PDumpIsCapturing(GLES2Context *gc)
{
