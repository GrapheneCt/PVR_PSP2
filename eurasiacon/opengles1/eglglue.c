...
static IMG_BOOL InitContext(GLES1Context *gc, GLES1Context *psShareContext, EGLcontextMode *psMode)
{
	...
	gc->pvUltRuntimeWorkArea = GLES1Malloc(gc, ui32UltRuntimeWorkAreaSize);
	gc->pvUltRuntime = GLES1Malloc(gc, _SCE_ULT_ULTHREAD_RUNTIME_SIZE);
	gc->pvUltThreadStorage = GLES1Malloc(gc, 4 * gc->sAppHints.ui32SwTexOpMaxUltNum);
	GLES1MemSet(gc->pvUltThreadStorage, 0, 4 * gc->sAppHints.ui32SwTexOpMaxUltNum);
...
FAILED_TASync:
	...
	GLES1Free(IMG_NULL, gc->pvUltThreadStorage);
	sceUltUlthreadRuntimeDestroy((SceUltUlthreadRuntime *)gc->pvUltRuntime);
	GLES1Free(IMG_NULL, gc->pvUltRuntimeWorkArea);
	GLES1Free(IMG_NULL, gc->pvUltRuntime);
...
static IMG_VOID (IMG_CALLCONV *GLESGetProcAddress(const char *procname))(IMG_VOID)
{
	...
	COMPARE_AND_RETURN(glActiveTexture)
	COMPARE_AND_RETURN(glAlphaFunc)
	COMPARE_AND_RETURN(glAlphaFuncx)
	COMPARE_AND_RETURN(glBindBuffer)
	COMPARE_AND_RETURN(glBindTexture)
	COMPARE_AND_RETURN(glBlendFunc)
	COMPARE_AND_RETURN(glBufferData)
	COMPARE_AND_RETURN(glBufferSubData)
	COMPARE_AND_RETURN(glClear)
	COMPARE_AND_RETURN(glClearColor)
	COMPARE_AND_RETURN(glClearColorx)
	COMPARE_AND_RETURN(glClearDepthf)
	COMPARE_AND_RETURN(glClearDepthx)
	COMPARE_AND_RETURN(glClearStencil)
	COMPARE_AND_RETURN(glClientActiveTexture)
	COMPARE_AND_RETURN(glClipPlanef)
	COMPARE_AND_RETURN(glClipPlanex)
	COMPARE_AND_RETURN(glColor4f)
	COMPARE_AND_RETURN(glColor4ub)
	COMPARE_AND_RETURN(glColor4x)
	COMPARE_AND_RETURN(glColorMask)
	COMPARE_AND_RETURN(glColorPointer)
	COMPARE_AND_RETURN(glCompressedTexImage2D)
	COMPARE_AND_RETURN(glCompressedTexSubImage2D)
	COMPARE_AND_RETURN(glCopyTexImage2D)
	COMPARE_AND_RETURN(glCopyTexSubImage2D)
	COMPARE_AND_RETURN(glCullFace)
	COMPARE_AND_RETURN(glDeleteBuffers)
	COMPARE_AND_RETURN(glDeleteTextures)
	COMPARE_AND_RETURN(glDepthFunc)
	COMPARE_AND_RETURN(glDepthMask)
	COMPARE_AND_RETURN(glDepthRangef)
	COMPARE_AND_RETURN(glDepthRangex)
	COMPARE_AND_RETURN(glDisable)
	COMPARE_AND_RETURN(glDisableClientState)
	COMPARE_AND_RETURN(glDrawArrays)
	COMPARE_AND_RETURN(glDrawElements)
	COMPARE_AND_RETURN(glEnable)
	COMPARE_AND_RETURN(glEnableClientState)
	COMPARE_AND_RETURN(glFinish)
	COMPARE_AND_RETURN(glFlush)
	COMPARE_AND_RETURN(glFogf)
	COMPARE_AND_RETURN(glFogfv)
	COMPARE_AND_RETURN(glFogx)
	COMPARE_AND_RETURN(glFogxv)
	COMPARE_AND_RETURN(glFrontFace)
	COMPARE_AND_RETURN(glFrustumf)
	COMPARE_AND_RETURN(glFrustumx)
	COMPARE_AND_RETURN(glGenBuffers)
	COMPARE_AND_RETURN(glGenTextures)
	COMPARE_AND_RETURN(glGetBooleanv)
	COMPARE_AND_RETURN(glGetBufferParameteriv)
	COMPARE_AND_RETURN(glGetClipPlanef)
	COMPARE_AND_RETURN(glGetClipPlanex)
	COMPARE_AND_RETURN(glGetError)
	COMPARE_AND_RETURN(glGetFixedv)
	COMPARE_AND_RETURN(glGetFloatv)
	COMPARE_AND_RETURN(glGetIntegerv)
	COMPARE_AND_RETURN(glGetLightfv)
	COMPARE_AND_RETURN(glGetLightxv)
	COMPARE_AND_RETURN(glGetMaterialfv)
	COMPARE_AND_RETURN(glGetMaterialxv)
	COMPARE_AND_RETURN(glGetPointerv)
	COMPARE_AND_RETURN(glGetString)
	COMPARE_AND_RETURN(glGetTexEnvfv)
	COMPARE_AND_RETURN(glGetTexEnviv)
	COMPARE_AND_RETURN(glGetTexEnvxv)
	COMPARE_AND_RETURN(glGetTexParameterfv)
	COMPARE_AND_RETURN(glGetTexParameteriv)
	COMPARE_AND_RETURN(glGetTexParameterxv)
	COMPARE_AND_RETURN(glHint)
	COMPARE_AND_RETURN(glIsBuffer)
	COMPARE_AND_RETURN(glIsEnabled)
	COMPARE_AND_RETURN(glIsTexture)
	COMPARE_AND_RETURN(glLightModelf)
	COMPARE_AND_RETURN(glLightModelfv)
	COMPARE_AND_RETURN(glLightModelx)
	COMPARE_AND_RETURN(glLightModelxv)
	COMPARE_AND_RETURN(glLightf)
	COMPARE_AND_RETURN(glLightfv)
	COMPARE_AND_RETURN(glLightx)
	COMPARE_AND_RETURN(glLightxv)
	COMPARE_AND_RETURN(glLineWidth)
	COMPARE_AND_RETURN(glLineWidthx)
	COMPARE_AND_RETURN(glLoadIdentity)
	COMPARE_AND_RETURN(glLoadMatrixf)
	COMPARE_AND_RETURN(glLoadMatrixx)
	COMPARE_AND_RETURN(glLogicOp)
	COMPARE_AND_RETURN(glMapBufferOES)
	COMPARE_AND_RETURN(glMaterialf)
	COMPARE_AND_RETURN(glMaterialfv)
	COMPARE_AND_RETURN(glMaterialx)
	COMPARE_AND_RETURN(glMaterialxv)
	COMPARE_AND_RETURN(glMatrixMode)
	COMPARE_AND_RETURN(glMultMatrixf)
	COMPARE_AND_RETURN(glMultMatrixx)
	COMPARE_AND_RETURN(glMultiTexCoord4f)
	COMPARE_AND_RETURN(glMultiTexCoord4x)
	COMPARE_AND_RETURN(glNormal3f)
	COMPARE_AND_RETURN(glNormal3x)
	COMPARE_AND_RETURN(glNormalPointer)
	COMPARE_AND_RETURN(glOrthof)
	COMPARE_AND_RETURN(glOrthox)
	COMPARE_AND_RETURN(glPixelStorei)
	COMPARE_AND_RETURN(glPointParameterf)
	COMPARE_AND_RETURN(glPointParameterfv)
	COMPARE_AND_RETURN(glPointParameterx)
	COMPARE_AND_RETURN(glPointParameterxv)
	COMPARE_AND_RETURN(glPointSize)
	COMPARE_AND_RETURN(glPointSizex)
	COMPARE_AND_RETURN(glPolygonOffset)
	COMPARE_AND_RETURN(glPolygonOffsetx)
	COMPARE_AND_RETURN(glPopMatrix)
	COMPARE_AND_RETURN(glPushMatrix)
	COMPARE_AND_RETURN(glReadPixels)
	COMPARE_AND_RETURN(glRotatef)
	COMPARE_AND_RETURN(glRotatex)
	COMPARE_AND_RETURN(glSampleCoverage)
	COMPARE_AND_RETURN(glSampleCoveragex)
	COMPARE_AND_RETURN(glScalef)
	COMPARE_AND_RETURN(glScalex)
	COMPARE_AND_RETURN(glScissor)
	COMPARE_AND_RETURN(glShadeModel)
	COMPARE_AND_RETURN(glStencilFunc)
	COMPARE_AND_RETURN(glStencilMask)
	COMPARE_AND_RETURN(glStencilOp)
	COMPARE_AND_RETURN(glTexCoordPointer)
	COMPARE_AND_RETURN(glTexEnvf)
	COMPARE_AND_RETURN(glTexEnvfv)
	COMPARE_AND_RETURN(glTexEnvi)
	COMPARE_AND_RETURN(glTexEnviv)
	COMPARE_AND_RETURN(glTexEnvx)
	COMPARE_AND_RETURN(glTexEnvxv)
	COMPARE_AND_RETURN(glTexImage2D)
	COMPARE_AND_RETURN(glTexParameterf)
	COMPARE_AND_RETURN(glTexParameterfv)
	COMPARE_AND_RETURN(glTexParameteri)
	COMPARE_AND_RETURN(glTexParameteriv)
	COMPARE_AND_RETURN(glTexParameterx)
	COMPARE_AND_RETURN(glTexParameterxv)
	COMPARE_AND_RETURN(glTexSubImage2D)
	COMPARE_AND_RETURN(glTranslatef)
	COMPARE_AND_RETURN(glTranslatex)
	COMPARE_AND_RETURN(glVertexPointer)
	COMPARE_AND_RETURN(glViewport)
