...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPack16(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	...
	{
		GLES1MemCopy(psSpanInfo->pvOutData, psSpanInfo->pvInData, psSpanInfo->ui32Width * sizeof(IMG_UINT16));
	}
	else
	{
		IMG_INT32 i32Increment = psSpanInfo->i32SrcGroupIncrement / 2;
		...
		do
		{
			*pui16OutData = *pui16InData;
			...
			pui16OutData++;
			pui16InData = pui16InData + i32Increment;
		}
		while(--i);
	}
}
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPack32(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	...
	{
		GLES1MemCopy(psSpanInfo->pvOutData, psSpanInfo->pvInData, psSpanInfo->ui32Width * sizeof(IMG_UINT32));
	}
	else
	{
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toRGBA4444(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT16 *pui16OutData = (IMG_UINT16 *) psSpanInfo->pvOutData;
	IMG_UINT16 ui16Invalue;
	IMG_INT32 i32Increment;
	 ...
	 */
	i = psSpanInfo->ui32Width;
	i32Increment = psSpanInfo->i32SrcGroupIncrement / 2;
...
/***********************************************************************************
 ...
 Description        : Converts a span of ARGB1555 pixels to RGBA5551
					  (needed for read format conversion)
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toRGBA5551(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT16 *pui16OutData = (IMG_UINT16 *) psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toABGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toXBGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toRGB565(const GLESPixelSpanInfo *psSpanInfo)
{
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toARGB4444(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT16 ui16OutData;
	IMG_UINT8 ui8Temp;
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toARGB1555(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT16 ui16OutData;
	IMG_UINT8 ui8Temp;
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toLuminanceAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT32 ui32Temp;
	IMG_UINT16 ui16OutData;
	...
	i = psSpanInfo->ui32Width;
	i32Increment = psSpanInfo->i32SrcGroupIncrement / 4;
	...
	do
	{
		...
		*pui16Dest = ui16OutData;
		...
		pui32Src = pui32Src + i32Increment;
		pui16Dest++;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB8888toLuminance(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT32 ui32Temp;
	IMG_UINT32 *pui32Src = (IMG_UINT32 *)psSpanInfo->pvInData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackAXXX8888toAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT32 ui32Temp;
	IMG_UINT8 *pui8Dest = (IMG_UINT8 *)psSpanInfo->pvOutData;
...
IMG_INTERNAL IMG_VOID SpanPackABGR8888toARGB8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT8 *pui8Src = (IMG_UINT8 *)psSpanInfo->pvInData;
	IMG_UINT8 *pui8Dest = (IMG_UINT8 *)psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackABGR8888toXBGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT8 *pui8Src = (IMG_UINT8 *)psSpanInfo->pvInData;
	IMG_UINT8 *pui8Dest = (IMG_UINT8 *)psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackABGR8888toRGB565(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT16 ui16OutData;
	IMG_UINT8 ui8Temp;
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackABGR8888toARGB4444(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT16 ui16OutData;
	IMG_UINT8 ui8Temp;
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackABGR8888toARGB1555(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT16 ui16OutData;
	IMG_UINT8 ui8Temp;
	IMG_UINT32 i;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackABGR8888toLuminanceAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT32 ui32Temp;
	IMG_UINT16 ui16OutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackABGR8888toLuminance(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT32 ui32Temp;
	IMG_UINT32 *pui32Src = (IMG_UINT32 *)psSpanInfo->pvInData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toABGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toXBGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toARGB8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toRGB565(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT16 ui16Temp;
	IMG_UINT8 ui8Red;
	...
	do
	{
		...
		*pui16Dest = (IMG_UINT16)((ui8Red << 11) | (ui8Green << 5) | ui8Blue);
		...
		pui16Src = pui16Src + i32Increment;
		pui16Dest++;
	}
	while(--i);
}
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toARGB1555(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT16 *pui16Src = (IMG_UINT16 *)psSpanInfo->pvInData;
	IMG_UINT16 *pui16Dest = (IMG_UINT16 *)psSpanInfo->pvOutData;
	...
	do
	{
		...
		/* Alpha */
		ui16OutData = (IMG_UINT16)((ui16InData & 0xF000) ? 0x8000 : 0);
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toLuminanceAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT16 ui16Temp;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toLuminance(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT8 ui8Temp;
	IMG_UINT16 *pui16Src = (IMG_UINT16 *)psSpanInfo->pvInData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB4444toAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT8 ui8Temp;
	IMG_UINT8 *pui8Dest = (IMG_UINT8 *)psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toABGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
	...
	do 
	{
		...
		pui8OutData[3] = (IMG_UINT8)((ui16InValue & 0x8000)? 0xFF : 0x00);
...
IMG_INTERNAL IMG_VOID SpanPackARGB1555toXBGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
...
IMG_INTERNAL IMG_VOID SpanPackARGB1555toARGB8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT16 *pui16InData = (const IMG_UINT16 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toRGB565(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT16 ui16Temp;
	IMG_UINT16 *pui16Src = (IMG_UINT16 *)psSpanInfo->pvInData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toARGB4444(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	...
	do
	{
		...
		/* alpha */
		ui16OutData = (IMG_UINT16)((ui16InData & 0x8000) ? 0xF000 : 0);
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toLuminanceAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT16 ui16Temp;
	IMG_UINT8 ui8OutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toLuminance(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT8 ui8Temp;
	IMG_UINT16 *pui16Src = (IMG_UINT16 *)psSpanInfo->pvInData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackARGB1555toAlpha(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT8 *pui8Dest = (IMG_UINT8 *)psSpanInfo->pvOutData;
	IMG_UINT16 *pui16Src = (IMG_UINT16 *)psSpanInfo->pvInData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackRGB565toXBGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT8 ui8OutData;
	IMG_UINT16 ui16Temp;
	IMG_UINT32 i;
	...
	do
	{
		...
		ui8OutData |= (IMG_UINT8)((ui8OutData & 0xE0) >> 5);
		*pui8Dest++ = ui8OutData;

		/* Green */
		ui8OutData  = (IMG_UINT8)((ui16Temp >> 5) << 2);
		ui8OutData |= (IMG_UINT8)((ui8OutData & 0xC0) >> 6);
		*pui8Dest++ = ui8OutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackRGB565toLuminance(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	IMG_UINT16 ui16Temp;
	IMG_UINT8 ui8OutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackXBGR8888to1BGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	const IMG_UINT32 *pui32InData = (const IMG_UINT32 *) psSpanInfo->pvInData;
	IMG_UINT32 *pui32OutData = (IMG_UINT32 *) psSpanInfo->pvOutData;
...
************************************************************************************/
IMG_INTERNAL IMG_VOID SpanPackXRGB8888to1BGR8888(const GLESPixelSpanInfo *psSpanInfo)
{
	IMG_UINT32 i;
	const IMG_UINT8 *pui8InData = (const IMG_UINT8 *) psSpanInfo->pvInData;
	IMG_UINT8 *pui8OutData = (IMG_UINT8 *) psSpanInfo->pvOutData;
