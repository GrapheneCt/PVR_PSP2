...
typedef IMG_VOID (* PFNDestroyHashItem)(GLES1Context *gc, IMG_UINT32 ui32Item);

typedef struct HashTableInsertInfo_TAG
{
	IMG_UINT32		ui32DeleteEntryHashChain;
	HashEntry		*psEntryToDelete;
	HashEntry		*psEntryAheadDelete;
	IMG_BOOL		bChecked;
}HashTableInsertInfo;
...
typedef struct HashTable_TAG
{
	...
	HashTableInsertInfo sInsertInfo;	/* Information about insert new item to this hash table */
...
IMG_BOOL HashTableCreate(GLES1Context		*gc,
...
IMG_VOID HashTableDestroy(GLES1Context *gc,
						  HashTable	   *psHashTable);
...
IMG_BOOL HashTableSearch(GLES1Context *gc,
						HashTable	  *psHashTable,
...
IMG_BOOL ValidateHashTableInsert(GLES1Context *gc, 
								 HashTable	  *psHashTable, 
								 HashValue	  tHashValue);

IMG_VOID HashTableInsert(GLES1Context *gc,
						HashTable	  *psHashTable,
						HashValue	  tHashValue,
						IMG_UINT32	  *pui32HashKey,
						IMG_UINT32	  ui32HashKeySizeInDWords,
...
IMG_BOOL HashTableDelete(GLES1Context *gc,
						HashTable	  *psHashTable,
						HashValue	  tHashValue,
						IMG_UINT32	  *pui32HashKey,
						IMG_UINT32	  ui32HashKeySizeInDWords,
